"""Round 4 batch: run `analyze --stages-only identify` against all 30 corpus slugs.

Serial, with incremental progress saving. Captures exit code, stderr line
matching `identify: slug=... source=... score=... mbid=... reason=...`,
and the resulting identify.json content.
"""
...
WORKTREE = REPO
CACHE = REPO / "cache"
OUT = WORKTREE / r"docs\superpowers\identify-overhaul\round-4-batch-records.json"
LOG = WORKTREE / r"docs\superpowers\identify-overhaul\round-4-batch.log"
